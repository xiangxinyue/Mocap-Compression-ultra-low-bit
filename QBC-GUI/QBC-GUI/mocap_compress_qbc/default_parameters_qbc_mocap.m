...
% % OUTPUT
% % MxAllowSqD: Maximum allowed squared distance
% % Delta:      Initial breakpoint interval
% % Q:          Control points are rounded to nPlaces decimal values


function [MxAllowSqD, Delta, Q] = default_parameters_qbc_mocap()

MxAllowSqD = 4;    % level (scale)   (default, lev=4)
Delta = 80;        % Initial breakpoint interval
Q=2;               % round cxd to fixed decimal places
